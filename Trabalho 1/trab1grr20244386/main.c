...
int testeBusca (size_t tamVetor, size_t incremento, int numTestes, int valorBuscar) {
    size_t idxBusca;
    uint64_t numComp;
    clock_t start, end;
    ...
    while (numTestes > 0) {
        ...
        if (idxBusca == (size_t)-1) printf("Nao existe\n");
...
int testeOrdenacao (size_t tamVetor, size_t incremento, int numTestes) {
    uint64_t numComp;
    clock_t start, end;
    double total;
...
int main() {
    ...
    /*printf("Quant. testes - busca: ");
    scanf("%d", &numTestes);

    printf("Incremento - busca: ");
    scanf("%ld", &incremento);*/
    ...
    //testeBusca(incremento, incremento, numTestes, valorBuscar);

    printf("Quant. testes - ordenacao: ");
    scanf("%d", &numTestes);

    printf("Incremento - ordenacao: ");
    scanf("%ld", &incremento);

    testeOrdenacao(incremento, incremento, numTestes);
